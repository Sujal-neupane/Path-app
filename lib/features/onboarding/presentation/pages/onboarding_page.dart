...
class _OnboardingPageState extends ConsumerState<OnboardingPage> {
  ...
  final List<Map<String, dynamic>> _pages = [
    {
      ...
      'subtitle':
          'Your virtual sherpa. We generate personalized climbing routes based on your fitness, budget, and time.',
    ...
    },
    {
      ...
      'subtitle':
          'Lose signal, not your way. Download topographic maps and let our character guide you precisely to the next teahouse.',
    ...
    },
    {
      'title': 'Trek Safely',
      'subtitle':
          'Built-in SOS, altitude sickness alerts, and live trail conditions ensure you reach the summit with complete peace of mind.',
  ...
  Future<void> _onNext() async {
    if (_currentIndex < _pages.length - 1) {
      ...
      await ref.read(onboardingStorageServiceProvider).markCompleted();
      if (!mounted) return;
      context.go('/login');
    }
  }
...
class _ContinuousFlowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(
      panX + size.width * 0.5,
      size.height * 0.6 - math.sin(pageOffset * math.pi) * 30,
      panX + size.width * 1.0,
      size.height * 0.45,
    );
    ...
    path.quadraticBezierTo(
      panX + size.width * 1.5,
      size.height * 0.3 + math.cos(pageOffset * math.pi) * 40,
      panX + size.width * 2.0,
      size.height * 0.5,
    );
    ...
    pathAccent.quadraticBezierTo(
      panXAccent + size.width * 0.8,
      size.height * 0.3 + math.sin(pageOffset * 2) * 50,
      panXAccent + size.width * 1.5,
      size.height * 0.65,
    );
    pathAccent.quadraticBezierTo(
      panXAccent + size.width * 2.5,
      size.height * 0.4,
      panXAccent + size.width * 3.5,
      size.height * 0.5,
    );
